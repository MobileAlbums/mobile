...
- (void)viewDidLoad
{
    ...
    ASIFormDataRequest *request = [ASIFormDataRequest requestWithURL:[NSURL URLWithString:@"http://mobilealbumsdemo.com//album_mng.php"]];
...
-(void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex{
    if (buttonIndex==1) {
        ...
        NSString * file_name = [NSString stringWithFormat:@"image-%d.png",[items count]];
        [request setData:img_data withFileName:file_name andContentType:@"image/jpeg" forKey:@"image"];
...
//    cell.detailTextLabel.text=@"detail";
    ...
    NSString *imageURL = [NSString stringWithFormat:@"http://mobilealbumsdemo.com/albums/%@",fileName];
...
-(void)actionSheet:(UIActionSheet *)actionSheet clickedButtonAtIndex:(NSInteger)buttonIndex {
    ...
    if (buttonIndex==0) {
        ...
        [request setPostValue:[items objectAtIndex:row] forKey:@"file_name"];
...
- (void)requestFinished:(ASIHTTPRequest *)request {
    ...
    if (request.responseStatusCode == 200) {
        ...
        if ([str rangeOfString:@"insert"].location != NSNotFound){
            ...
            [items addObject:[datas valueForKey:@"file_name"]];
