...
- (void)viewDidLoad {
    ...
    album_id=[self.albumViewController.albumIds objectAtIndex:self.selectedAlbumTableViewIndex];  
    ASIFormDataRequest *request = [ASIFormDataRequest requestWithURL:[NSURL URLWithString:@"http://mobilealbumsdemo.com/picture_mng.php"]];
...
-(void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex{
    if (buttonIndex==1) {
        ...
        NSString *file_name = [NSString stringWithFormat:@"image-%d-%d.png",self.selectedAlbumTableViewIndex,[items2 count]];
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSString *imageURL = [NSString stringWithFormat:@"http://mobilealbumsdemo.com/pictures/%@",fileName];
